function projection = get_dual_projection_point_cloud_registration(N)
...
%     A12 = [A1, A2];
    ...
    projection.type = 'point cloud registration';
    projection.N = N;
    projection.A = A;
    ...
    fprintf('projection point cloud registration: N=%d.\n',N);
