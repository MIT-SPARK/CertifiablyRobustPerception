function certification = tls_point_cloud_registration_certification_hybrid_cloud(problem,solution,varargin)
...
%     chordal_certificate = struct;
%     chordal_certificate.relDualityGap = 1.0;
%     chordal_certificate.time_chordal_sdp = 0.1;
...
%         x0 = randn(nrDualVars_free+dim_svect+dim_svecp,1);
...
function projection = compute_dual_projection(problem,f_est)
    ...
    filename = sprintf('projection_pcr_%d.mat',N);
