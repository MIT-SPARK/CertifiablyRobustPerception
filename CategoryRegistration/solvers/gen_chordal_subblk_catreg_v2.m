function out = gen_chordal_subblk_catreg_v2(basis,basis_x,h_x,basis_theta,h_theta,g_x,basis_g,f_cost)
...
%% Now build the constraints for the sub PSD constraints
Asub            = {};
for k = 1:nrIneq
