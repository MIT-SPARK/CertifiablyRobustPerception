function out = gen_chordal_subblk_ape(basis,basis_x,h_x,basis_theta,h_theta,g_x,basis_g,f_cost,varargin)

params = inputParser;
params.CaseSensitive = false;
params.addParameter('checkMonomials',false, @(x) islogical(x));
...
out.blk         = blk;
out.b           = b;
out.C           = {C;sparse(n1,n1);sparse(n1,n1);sparse(n1,n1)};
out.m           = m;
out.m_mom       = m_mom;
out.m_loc       = m_loc;
